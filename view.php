...
<head>
    ...
    <title>নিবন্ধন বিবরণ - ডিজিটাল নিকাহনামা রেজিস্ট্রি</title>
    <!-- Bootstrap 5 CSS -->
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
            <div>
                <h3 class="fw-bold mb-1 text-dark">
                    <i class="fa-solid fa-file-invoice me-2 text-warning"></i>বিবাহ নিবন্ধনের বিস্তারিত তথ্য
                </h3>
            ...
            <div class="d-flex flex-wrap gap-2">
                ...
                <a href="pdf.php?id=<?php echo $cert['id']; ?>" target="_blank" class="btn btn-sm btn-outline-success">
                    <i class="fa-solid fa-file-pdf me-1"></i> পিডিএফ ডাউনলোড
                </a>
            ...
            <div class="col-lg-8">
                ...
                <div class="row g-4 mb-4">
                    <div class="col-md-6">
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            <div class="card-header bg-dark text-white py-3">
                                <h5 class="mb-0 fw-bold"><i class="fa-solid fa-user-tie text-warning me-2"></i>বরের বিবরণ</h5>
                            </div>
                            <div class="card-body">
                                <table class="table table-borderless small mb-0">
                                    <tr>
                                        <td class="fw-bold text-muted w-35">নাম:</td>
                                        <td class="fw-semibold text-dark"><?php echo sanitize($cert['groom_name']); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-muted">মোবাইল:</td>
                                        <td><?php echo sanitize($cert['groom_phone']); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-muted">পিতা:</td>
                                        <td><?php echo sanitize($cert['groom_father']); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-muted">মাতা:</td>
                                    ...
                                    <tr>
                                        <td class="fw-bold text-muted">পাসপোর্ট:</td>
                                        <td><?php echo sanitize($cert['groom_passport'] ?? 'N/A'); ?></td>
                                    </tr>
                                    <tr>
                                        <td class="fw-bold text-muted">ঠিকানা:</td>
                    ...
                    <div class="col-md-6">
                        <div class="card border-0 shadow-sm rounded-4 h-100">
                            <div class="card-header bg-dark text-white py-3">
                                <h5 class="mb-0 fw-bold"><i class="fa-solid fa-user-dress text-warning me-2"></i>কনের বিবরণ</h5>
                            </div>
                            <div class="card-body">
                                <table class="table table-borderless small mb-0">
                                    <tr>
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-header bg-white py-3">
                        <h5 class="mb-0 fw-bold text-dark"><i class="fa-solid fa-ring text-warning me-2"></i>বিবাহ ও দেনমোহরের বিবরণ</h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3 small">
                            <div class="col-md-6">
                                <div class="p-2 border-bottom">
                                    <span class="fw-bold text-muted d-block">বিবাহের তারিখ ও সময়:</span>
                                    <span class="text-dark fw-semibold"><?php echo sanitize($cert['marriage_date']) . ' সময় ' . date('h:i A', strtotime($cert['marriage_time'])); ?></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="p-2 border-bottom">
                                    <span class="fw-bold text-muted d-block">অভিভাবক / ওয়ালী:</span>
                                    <span class="text-dark fw-semibold"><?php echo sanitize($cert['wali_name'] ?? 'নাই'); ?></span>
                                </div>
                            </div>
                            <div class="col-12">
                                <div class="p-2 border-bottom">
                                    <span class="fw-bold text-muted d-block">বিবাহের স্থান:</span>
                            ...
                            <div class="col-md-4">
                                <div class="p-2">
                                    <span class="fw-bold text-muted d-block">দেনমোহরের অবস্থা:</span>
                ...
                <div class="card border-0 shadow-sm rounded-4 mb-4">
                    <div class="card-header bg-white py-3">
                        <h5 class="mb-0 fw-bold text-dark"><i class="fa-solid fa-users text-warning me-2"></i>সাক্ষী ও কাজীর বিবরণ</h5>
                    </div>
                    <div class="card-body">
                        <div class="row g-3 small">
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded-3 h-100">
                                    ...
                                    <span class="text-muted">NID নম্বর: <strong class="text-dark"><?php echo sanitize($cert['witness1_nid']); ?></strong></span>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="p-3 bg-light rounded-3 h-100">
                                    ...
                                    <span class="text-muted">NID নম্বর: <strong class="text-dark"><?php echo sanitize($cert['witness2_nid']); ?></strong></span>
                                </div>
                            </div>
                            <div class="col-12 mt-4">
                                <span class="fw-bold text-dark d-block mb-2">নিকাহ রেজিস্টার (কাজী) সংক্রান্ত তথ্য:</span>
                                <div class="row g-3 border-top pt-2">
                                    <div class="col-md-4">
                                        <span class="text-muted d-block small">নাম:</span>
                                        <span class="fw-semibold text-dark"><?php echo sanitize($cert['registrar_name']); ?></span>
                                    </div>
                                    <div class="col-md-4">
                                        <span class="text-muted d-block small">লাইসেন্স নম্বর:</span>
                                        <span class="fw-semibold text-primary"><?php echo sanitize($cert['registrar_license']); ?></span>
                                    </div>
                                    <div class="col-md-4">
                                        <span class="text-muted d-block small">মোবাইল নম্বর:</span>
                                        <span class="fw-semibold text-dark"><?php echo sanitize($cert['registrar_phone']); ?></span>
                                    </div>
                                    <div class="col-12">
                                        <span class="text-muted d-block small">কার্যালয়ের ঠিকানা:</span>
                                        <span class="fw-semibold text-dark"><?php echo sanitize($cert['registrar_address']); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="col-lg-4">
                <div class="card border-0 shadow-sm rounded-4 text-center p-4 mb-4">
                    ...
                    <div class="p-3 bg-light rounded-3 mb-3">
                        <span class="text-muted small d-block uppercase fw-bold">সার্টিফিকেট নম্বর</span>
                        <strong class="text-primary d-block fs-5"><?php echo sanitize($cert['certificate_no']); ?></strong>
                    </div>
                    <div class="p-3 bg-light rounded-3 mb-4">
                        <span class="text-muted small d-block uppercase fw-bold">নিবন্ধন নম্বর</span>
                        <strong class="text-dark d-block fs-5"><?php echo sanitize($cert['registration_no']); ?></strong>
                    </div>

                    <!-- QR Code verification panel -->
                    <div class="border-top pt-4">
                        <h6 class="fw-bold text-dark mb-3"><i class="fa-solid fa-qrcode me-2 text-warning"></i>যাচাইকরণের কিউআর কোড</h6>
                        ...
                        <p class="text-muted small mb-0">এই কিউআর কোডটি মোবাইল ক্যামেরা দিয়ে স্ক্যান করে অনলাইনে নিবন্ধনের সত্যতা যাচাই করা যাবে।</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content border-0 shadow">
                    ...
                    <div class="modal-body py-4 text-center">
                        ...
                        <p class="text-muted mb-0 small">এই কাজটি বাতিল করা যাবে না। এটি চিরতরে ডেটাবেজ থেকে <strong><?php echo sanitize($cert['certificate_no']); ?></strong> সার্টিফিকেট রেকর্ডটি মুছে ফেলবে।</p>
                    </div>
