                ...
                <?php if ($type === 'certificate'): ?>
                    ...
                    <div class="cert-section" style="margin-top: 30px;">
                        <div class="statement-text">
                            ...
                            <span class="d-block text-center fw-bold my-3 fs-5">"أَشْهَدُ أَنْ لَا إِلٰهَ إِلَّا اللهُ وَأَشْهَدُ أَنَّ مُحَمَّদًا عَبْدُهُ وَরَسُولُهُ"</span>
                ...
                <?php elseif ($type === 'affidavit'): ?>
                    ...
                    <div class="cert-section" style="margin-top: 30px;">
                        <div class="statement-text">
                            আমি <strong><?php echo sanitize($cert['new_name']); ?></strong>, পূর্বের নাম: <strong><?php echo sanitize($cert['previous_name']); ?></strong>, 
                            পিতা: <strong><?php echo sanitize($cert['father_name']); ?></strong>, মাতা: <strong><?php echo sanitize($cert['mother_name']); ?></strong>, 
                            ধর্ম: islam (পূর্বের ধর্ম: <?php echo sanitize($cert['previous_religion']); ?>), পেশা: চাকরি/ব্যবসা, 
                ...
                <?php else: ?>
                    ...
                    <div class="cert-section" style="margin-top: 30px;">
                        <div class="statement-text">
                            ...
                            <p class="mt-3">আমরা প্রত্যয়ন করছি যে, অদ্য <strong><?php echo sanitize($cert['declaration_date']); ?></strong> তারিখে তিনি আমাদের प्रत्यक्ष উপস্থিতিতে সম্পূর্ণ সুস্থ মস্তিষ্কে ও স্বেচ্ছায় কোনো প্ররোচনা ছাড়াই পবিত্র ইসলাম ধর্ম গ্রহণ করেছেন। আমরা তাঁর কালেমা পাঠের প্রত্যক্ষ সাক্ষী।</p>
